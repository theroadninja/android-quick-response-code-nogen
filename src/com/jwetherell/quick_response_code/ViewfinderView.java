...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        maskColor = Configurations.viewfinder_mask;
        resultColor = Configurations.result_view;
        frameColor = Configurations.viewfinder_frame;
        laserColor = Configurations.viewfinder_laser;
        resultPointColor = Configurations.possible_result_points;
        scannerAlpha = 0;
